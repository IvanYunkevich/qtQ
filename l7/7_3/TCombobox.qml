...
T.ComboBox {
    ...
    PropertyAnimation {id: indicatorAnimOpen; target: indicatorImage; properties: "rotation"; to: 270; duration: 1}
    PropertyAnimation {id: indicatorAnimClose; target: indicatorImage; properties: "rotation"; to: 0; duration: 1}
}
